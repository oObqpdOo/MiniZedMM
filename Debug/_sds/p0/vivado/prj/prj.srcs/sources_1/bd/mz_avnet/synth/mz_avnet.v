...
//Date        : Wed Oct 23 12:49:07 2019
//Host        : bqpd-ThinkPad-T450s running 64-bit Linux Mint 19.2 Tina
//Command     : generate_target mz_avnet.bd
//Design      : mz_avnet
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "mz_avnet,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=mz_avnet,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=5,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SDSoC,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "mz_avnet.hwdef" *) 
module mz_avnet
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  mz_avnet_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
        .ext_reset_in(processing_system7_0_FCLK_RESET0_N),
        .mb_debug_sys_rst(1'b0),
        .slowest_sync_clk(processing_system7_0_FCLK_CLK0));
  mz_avnet_proc_sys_reset_1_0 proc_sys_reset_1
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
        .ext_reset_in(processing_system7_0_FCLK_RESET0_N),
        .mb_debug_sys_rst(1'b0),
        .slowest_sync_clk(processing_system7_0_FCLK_CLK1));
  mz_avnet_processing_system7_0_0 processing_system7_0
  ...
  mz_avnet_sds_irq_const_0 sds_irq_const
       (.dout(sds_irq_const_dout));
  mz_avnet_xlconcat_0_0 xlconcat_0
