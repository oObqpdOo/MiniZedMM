...
HD_PWD='/home/bqpd/workspace_sdsoc/MiniZedMM/Debug/_sds/p0/vivado/prj/prj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mz_avnet_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mz_avnet_wrapper.tcl
